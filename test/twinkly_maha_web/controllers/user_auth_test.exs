defmodule TwinklyMahaWeb.UserAuthTest do
  use TwinklyMahaWeb.ConnCase, async: true

  alias TwinklyMaha.Accounts
  alias TwinklyMahaWeb.UserAuth
  import TwinklyMaha.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, TwinklyMahaWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      TwinklyMahaWeb.Endpoint.subscribe(live_socket_id)

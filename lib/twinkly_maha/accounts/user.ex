defmodule TwinklyMaha.Accounts.User do
  @moduledoc false
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, TwinklyMaha.Repo)
  ...
  """
  def valid_password?(%TwinklyMaha.Accounts.User{hashed_password: hashed_password}, password)
